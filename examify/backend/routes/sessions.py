...
Handles quiz sessions, answer submission, and scoring.
"""
...
from app import db
from models import QuizSession, Question, QuestionSet
...
def submit_answers():
    ...
    Submit answers for a quiz session and receive scored results.
    Body: {
        "session_id": int,
...
def get_session(session_id):
    """GET /api/sessions/<id> - Retrieve a session's results."""
...
def list_sessions():
    """GET /api/sessions?set_id=<id> - List quiz sessions."""
